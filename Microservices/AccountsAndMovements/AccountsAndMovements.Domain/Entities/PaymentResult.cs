...
/// <summary>
/// Codigos que devuelven pay.EJECUTAR_PAGO_QR y pay.APLICAR_MOVIMIENTO. Un valor
/// positivo es el ID del movimiento aplicado; los negativos son fallos de
/// negocio, no excepciones: el SP ya hizo rollback de lo que hiciera falta.
/// </summary>
public struct PaymentResult
{
    ...
    public const long MERCHANT_ACCOUNT_NOT_FOUND = -4;
    public const long MERCHANT_ACCOUNT_INACTIVE  = -5;
