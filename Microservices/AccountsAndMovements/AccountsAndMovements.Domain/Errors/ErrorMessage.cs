...
public struct ErrorMessage
{
    ...
    public const string MERCHANT_NOT_FOUND     = "El comercio indicado no existe.";
    public const string MERCHANT_INACTIVE      = "El comercio indicado se encuentra inactivo.";
    ...
    public const string MERCHANT_ACCOUNT_NOT_FOUND = "El comercio no tiene una cuenta habilitada para cobrar.";
    public const string MERCHANT_ACCOUNT_INACTIVE  = "La cuenta del comercio se encuentra inactiva.";
    public const string MERCHANT_CURRENCY_INVALID  = "Las cuentas de comercio solo pueden operar en BOB.";
