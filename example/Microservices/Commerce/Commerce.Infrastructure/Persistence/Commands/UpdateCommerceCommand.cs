...
public class UpdateCommerceCommand(CommerceEntity entity) : SqlCommandBase<long>
{
    public override string Name => "commerce.UPDATE_COMERCIO";

    public override IEnumerable<SqlParameter>? Parameters =>
    [
        new() { ParameterName = "@COME_ID_IT",     SqlDbType = SqlDbType.BigInt,    Value = entity.CommerceId },
