...
namespace Coin.Application.Behaviors;
    ...
    where TRequest : IRequest<TResponse>
{
        ...
        TRequest request, RequestHandlerDelegate<TResponse> next, CancellationToken ct)
    {
        ...
        // When TResponse is BaseResponse<T>, return ValidationError directly (VAL001)
        ...
        // Fallback: throw an exception that LoggerInterceptor reports as ERR001
